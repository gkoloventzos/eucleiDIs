...
class No_Constructor(Exception):
    ...
    def repr(self):
        print('{self.name} has no constructor with this arguments' .format(self=self), end=' ')
        for i in range(self.parameters):
            if self.parameters[i] != None:
                print('{self.parameters[i]}' .format(self=self), end=' ')
...
class Wrong_Arguments(Exception):
    ...
    def __init__(self,value):
        self.name = type(value).__name__
    def repr(self):
        print('{self.name} cannot take this arguments' .format(self=self), end=' ')
        for i in range(self.parameters):
            if self.parameters[i] != None:
                print('{self.parameters[i]}' .format(self=self), end=' ')
...
class Polygon_2(object):
    ...
    def is_simple(self):
        ...
        for i in range(len(self._segments)-1):
            for j in range(i+2,len(self._segments)):
